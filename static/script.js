function straighten(message) {
  ...
  "<span style='font-weight: bold; font-family: Arial; font-size: 25px;'>$1</span>");
    ...
    textContent = textContent.replace(/\`\`\`(.*?)\`\`\`/g,
        "<span style='font-weight: bold; font-family: 'Arial'; font-size: 25px; text-color: purple;'>$1</span>");
